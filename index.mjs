// Handle different ways Fuse.js might be imported
import FuseModule from 'fuse.js';
import { readFileSync } from 'fs';
import { fileURLToPath } from 'url';
import { dirname, join } from 'path';

// Normalize Fuse constructor (handle both default export and named export scenarios)
...
const timezoneData = JSON.parse(
  readFileSync(join(__dirname, 'data', 'timezone-data.json'), 'utf8')
);
